...
See `docs/SPEC.md` for what the site does and should do, `docs/wiki/` for how it works
(read that before the source), and `docs/wiki/decisions/` for why it is shaped that way.
